...
from ._internal._tools_text_batch import (
    _dedupe_lines,
    _extract_emails,
    _extract_urls,
    _hex_convert,
...
from ._internal._tools_text_more import (
    _case_convert,
    _clamp,
    _diff_lines,
    _duration_parse,
...
_HANDLERS: dict[str, Any] = {
    ...
    "util_semver_compare": _semver_compare,
    "util_word_count": _word_count,
    "util_markdown_to_text": _markdown_to_text,
    "util_duration_parse": _duration_parse,
    "util_case_convert": _case_convert,
    "util_query_string": _query_string,
    "util_url_join": _url_join,
    "util_percent_change": _percent_change,
    "util_clamp": _clamp,
    "util_luhn_check": _luhn_check,
    "util_isbn_check": _isbn_check,
    "util_diff_lines": _diff_lines,
    "util_levenshtein": _levenshtein,
    "util_similarity": _similarity,
    "util_normalize_whitespace": _normalize_whitespace,
    "util_extract_urls": _extract_urls,
    "util_extract_emails": _extract_emails,
    "util_url_encode": _url_encode,
    "util_hex_convert": _hex_convert,
    "util_number_base": _number_base,
    "util_dedupe_lines": _dedupe_lines,
    "util_sort_lines": _sort_lines,
    "util_random_int": _random_int,
    "util_rot13": _rot13,
    "util_text_truncate": _text_truncate,
    "util_reading_time": _reading_time,
    "util_random_choice": _random_choice,
